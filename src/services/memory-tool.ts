...
import { formatRecallHit, normalizeRecallResult } from "./recall-results.js";
import type { ResolvedTags } from "./tags.js";

export const SUPERMEMORY_TOOL_DESCRIPTION =
...
export const SUPERMEMORY_RECALL_TOOL_DESCRIPTION =
  "Search saved Supermemory context for this repository and user. This least-privilege helper only accepts search operations.";
...
export const MEMORY_TOOL_SCOPES = ["user", "project"] as const;
...
export interface MemoryToolOptions {
  ...
  configured?: boolean;
  /** Called after a memory is stored through the tool. */
  onSaved?: () => void;
}

/**
 * Shared implementation of the `supermemory` tool used by both the OpenCode V1
 * plugin and the OpenCode 2 server plugin, so both generations behave alike.
 */
